    ...
    function rgbKineticSlider(options) {
        ...
        const canvas = document.getElementById(options.classname);
        ...
        function build_scene() {
            ...
            renderer.view.style.height = '791px';
            ...
            renderer.view.style.backgroundColor = 'white';
...
var bg = new PIXI.Sprite(PIXI.Texture.WHITE);
        ...
        document.addEventListener('scroll', function () {
            ...
            if (isInViewport(canvas)) {
                //console.log('hooray ' + options.classname);
                console.log('dfd');
                slideTransition(currentIndex + 1);
            }
        });
